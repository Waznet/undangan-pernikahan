...
@section('content')
  <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Edit Tampilan / Hadiah /</span> Tambah Hadiah</h4>
  ...
  <div class="card">
    <div class="card-body">
      <form>
        ...
        {{-- Deskripsi --}}
        <div class="mt-3">
          <a href="/admin/edit/hadiah/data" class="btn btn-primary">
            <i class="bx bx-save me-1"></i>Simpan</button>
          </a>
        </div>
      </form>
    </div>
