...
<head>
    ...
    <meta name="author" content="Rizkillah">
    ...
    <meta property="og:image"
        content="https://sandiperdiansah.github.io/wedding-invitation/src/assets/images/couple.png">
    <meta property="og:url" content="https://sandiperdiansah.github.io/wedding-invitation">
    ...
    <!-- Canonical URL -->
    <link rel="canonical" href="https://sandiperdiansah.github.io/wedding-invitation">
    ...
    <!-- Favicon -->
    <link rel="shortcut icon" href="/main/src/assets/images/icon.png" type="image">

    <!-- css -->
    <link rel="stylesheet" href="/main/src/assets/styles/global.css">
    <link rel="stylesheet" href="/main/src/css/navbar.css">
    <link rel="stylesheet" href="/main/src/css/welcome.css">
    <link rel="stylesheet" href="/main/src/css/home.css">
    <link rel="stylesheet" href="/main/src/css/bride.css">
    <link rel="stylesheet" href="/main/src/css/time.css">
    <link rel="stylesheet" href="/main/src/css/galeri.css">
    <link rel="stylesheet" href="/main/src/css/wishas.css">
    <link rel="stylesheet" href="/main/src/css/footer.css">
    <link rel="stylesheet" href="/main/src/css/mediaQueries.css">
    <link rel="stylesheet" href="/main/src/css/location.css">
    <link rel="stylesheet" href="/main/src/css/love-story.css">

    <title>Ridwan-Jofanny Wedding</title>
</head>
...
<body>
    ...
    <main role="main">
        ...
        <section class="hadist" aria-labelledby="hadist-title">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320" aria-hidden="true">
                <path fill="#f8f9fa" fill-opacity="1"
                    d="M0,0L48,32C96,64,192,128,288,138.7C384,149,480,107,576,106.7C672,107,768,149,864,144C960,139,1056,85,1152,69.3C1248,53,1344,75,1392,85.3L1440,96L1440,320L1392,320C1344,320,1248,320,1152,320C1056,320,960,320,864,320C768,320,672,320,576,320C480,320,384,320,288,320C192,320,96,320,48,320L0,320Z">
                </path>
            </svg>
        ...
        <section class="map-container">
            <div class="map-wrapper">
                <h2>Lokasi Acara</h2>
                <iframe
                    src="https://www.google.com/maps/embed/v1/place?key=AIzaSyA0s1a7phLN0iaD6-UE7m4qP-z21pH0eSc&q=grand+jatra+hotel+pekanbaru"
                    width="600" height="450" style="border:0;" allowfullscreen="">
                </iframe>
            </div>
        </section>

        <!-- Add Love Story Section Here -->
        <section class="love-story" id="love-story" aria-labelledby="love-story-title">
            ...
            <div class="love-story-bg"></div>

            <!-- Title -->
            <h2 id="love-story-title" data-aos="zoom-in" data-aos-duration="1000">Love Story</h2>

            <!-- Introduction paragraph -->
            <p class="intro" data-aos="zoom-in" data-aos-duration="1000">
                Cinta datang dengan caranya sendiri, mengajarkan arti memilih dan melepaskan. Kini, di ambang
                pernikahan, hati bergetar antara kebahagiaan dan harapan. Masa lalu telah menjadi kenangan, sementara
                masa depan menanti dengan janji dan impian.
            </p>
            ...
            <div class="timeline-event" data-aos="fade-up" data-aos-duration="1000">
                ...
                <p>
                    Pertemuan itu sederhana, tanpa rencana, namun meninggalkan jejak yang tak terhapus waktu. Tatapan
                    pertama, percakapan singkat, dan senyuman yang diam-diam mengundang rasa, semua menjadi awal dari
            ...
            <div class="timeline-event" data-aos="fade-up" data-aos-duration="1000">
                ...
                <p>
                    Di antara janji dan harapan, dua hati akhirnya memilih untuk melangkah bersama. Cincin melingkar di
                    jari, bukan sekadar perhiasan, tetapi simbol dari keyakinan bahwa perjalanan ini bukan lagi tentang
                    "aku" atau "kamu", melainkan "kita".
                </p>
            </div>
            ...
            <div class="timeline-event" data-aos="fade-up" data-aos-duration="1000">
                ...
                <p>
                    ...
                    serta menciptakan cerita yang akan terus hidup dalam waktu.
                </p>
            </div>

            <i class="bx bx-heart" aria-hidden="true"></i>

            <!-- Wave separator to match the rest of the template -->
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320" aria-hidden="true">
                <path fill="#f8f9fa" fill-opacity="1"
                    d="M0,96L48,122.7C96,149,192,203,288,197.3C384,192,480,128,576,122.7C672,117,768,171,864,160C960,149,1056,75,1152,64C1248,53,1344,107,1392,133.3L1440,160L1440,0L1392,0C1344,0,1248,0,1152,0C1056,0,960,0,864,0C768,0,672,0,576,0C480,0,384,0,288,0C192,0,96,0,48,0L0,0Z">
                </path>
        ...
        <section class="wishas" id="wishas">
            ...
            <div data-aos="zoom-in" data-aos-duration="1000">
                ...
                <form>
                    ...
                    <input type="text" name="name" id="name" placeholder="masukan nama anda" autoComplete="off"
                        required />
                    ...
                    <textarea name="message" id="message" placeholder="Tulis ucapan & Doa" required
    ...
    <footer>
        ...
        <!-- <div>
        <p>Build with <span>Sandi Perdiansah</span></p>
        <a href="https://github.com/sdprdh">
            <i class="bx bxl-github"></i>
            <span>sandiperdiansah</span>
        </a>
    </div> -->
    </footer>

    <script src="https://unpkg.com/aos@next/dist/aos.js"></script>
    <script src="/main/src/main.js" type="module"></script>
</body>
