import {
    ...
    getCurrentDateTime,
    renderElement
} from "/main/src/utils/helper.js";
import {data} from "/main/src/assets/data/data.js";
import {comentarService} from "/main/src/services/comentarService.js";
...
export const wishas = () => {
    ...
    const listItemBank = (data) => (
        `  <figure data-aos="zoom-in" data-aos-duration="1000">
                ...
                <figcaption>No. Rekening ${data.rekening.slice(0, 15)} <br>A.n ${data.name}</figcaption>
