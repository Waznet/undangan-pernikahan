...
import {addClassElement, getQueryParameter, removeClassElement} from "/main/src/utils/helper.js";
...
export const welcome = () => {
    ...
    const generateParameterContent = () => {
        ...
        if (params) {
            ...
            weddingToElement.innerHTML = `Kepada Yth Bapak/Ibu/Saudara/i<br><span>Rizkillah Ramanda Sinyo</span>`;
        }
    }
